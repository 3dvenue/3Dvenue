...
<header>
    <div class="inner">
        ...
        <a href="./expo.php" id="goback" class="btn">Back</a>
    </div>
</header>
<div id="eyecatch" <?=$bgstyle?>>
    <div id="background" class="no-capture" data-name="photoUpload" data-title="Background"><img src="img/photo.svg"></div>
    <div id="eyecatchfilter">
    </div>

    <div class="inner">
        <div class="overlay">
        <h1 data-name="name" data-title="Title"><?=$name?></h1>
        <h2 data-name="subtitle" data-title="Subtitle"><?=$subtitle?></h2>

        <div id="period" class="period" data-name="period" data-title="Term" data-start="<?=date("Y-m-d", strtotime($start))?>" data-end="<?=date("Y-m-d", strtotime($end))?>">
            <span>Term:</span>
            <span class="month"><?=date("M", strtotime($start))?></span>
            <span> </span>
            <span class="day"><?=date("j", strtotime($start))?></span>
            <span>,</span>
            <span class="year"><?=date("Y", strtotime($start))?></span>
            <span class="week">(<?=$week[date("w", strtotime($start))];?>)</span>
            <span> – </span>
            <span class="month"><?=date("M", strtotime($end))?></span>
            <span> </span>
            <span class="day"><?=date("j", strtotime($end))?></span>
            <span>,</span>
            <span class="year"><?=date("Y", strtotime($end))?></span>
            <span class="week">(<?=$week[date("w", strtotime($end))];?>)</span>
        </div>

        <div id="organizers" class="organizers" data-name="organizers" data-title="Organizers">Organized by: <span><?=$organizers?></div>

        </div>
     </div>
     <div id="makebana" class="no-capture"><img src="../img/camera.svg" alt="Create Banner"><span id="bana">Create Banner</span></div>
    </div>

<main>
<section id="about">
    <div class="inner">
        <h2>About<div class="palette"><img src="img/palette.svg"></div></h2>
        <p class="about" data-name="description" data-title="Avout"><?=$description?></p>
    </div>
</section>

<section id="venue">
    <div class="inner">
        <h2>Exhibitors<div class="palette"><img src="img/palette.svg"></div></h2>
        ...
        <p class="category" data-name="category" data-title="Add Category" data-subid="<?=$category?>">
                ...
                <?php } ?>
                <span data-cid="" data-type="new" data-name="new">Add Category</span>
        </p>

        <h3>Benefits</h3>
            <ul class="benefit" data-name="benefit" data-title="Benefits">
            <?php
...
<section id="exhibitors">
    <div class="inner">
        <h2>Exhibitor List<div class="palette"><img src="img/palette.svg"></div></h2>
        <p></p>
</div>
</section>
</main>
    ...
    <div id="form">
        ...
        <form method="POST" id="textedit">
            ...
            <div id="category">
                ...
                <input type="text" name="cdata" id="cdata" value="" placeholder="new Category"/>
                <div id="category_btn">
                    <button type="submit" name="submit" class="save" value="add">Save</button>
                    <button type="submit" name="submit" class="dell" value="dell">Delete</button>
                    <button type="submit" name="submit" class="edit" value="edit">Edit</button>
                </div>
            </div>
