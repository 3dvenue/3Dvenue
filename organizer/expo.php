...
<div class="expo">
<a href="editExpo.php?id=<?=$id?>" class="expoEdit">Edit</a>
<h3><?=$name?></h3>
    <div class="expomemo">
        <figure class="left">
            <img src="<?=$imagePath?>">
        ...
        <div class="right">
            ...
            <div class="public">
                <label class="<?=$ng?>">Open: <input type="checkbox" class="public" data-id="<?=$id?>" name="public" value="1" <?=$checked?>><span class="CheckBox"></span></label>
                <div class="exhibitors" data-id="<?=$id?>">Exhibitors</div>
            </div>
        </div>
