...
$queries[] = "INSERT IGNORE INTO `venue` (id, name, subtitle, organizers, description, start, end, created_at, organizer, public) 
              VALUES (1, 'ZERO Square Japan', 'The Origin of 3D Space', '3Dvenue', 'The point where everything begins.', NOW(), NOW() + INTERVAL 6 DAY, NOW(), 1, 0);";
...
exit("Setup completed successfully! Please reload.");
?>