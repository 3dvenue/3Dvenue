...
<div class="schedule">
<p><?=date("Y-m-d", strtotime($row['start']))?></p>
<p><?=date("Y-m-d", strtotime($row['end']))?></p>
</div>
<div class="exhibitorbtn"><button class="exhibitor btn" data-id="<?=$id?>" data-name="<?=$name?>">参加企業</button></div>
</div>
<?php  } ?>
</div>
