...
<tr data-cid="<?=$cid?>" data-status="<?=$status?>" class="s<?=$status?>">
    ...
    <td class="set"><div class="setbox s<?=$status?>"><span class="yes">Yes</span><span class="ban">Ban</span><span class="off">Off</span></div></td>
</tr>
<?php } ?>
</table>
...
<div id="companyedit">
    <div id="check">
        ...
        <p>Access the MyPage.</p>
        <input type="hidden" name="cid" id="cid" />
        <div id="button"><span class="btn" id="mypage">Open MyPage</span></div>        
    </div>
</div>

<div id="frame">
        <div class="close">&times;</div>
        <div id="iframetitile">Company Page</div>
